...
/*
 *
 * ExampleModule.cc source template automatically generated by a class generator
...
namespace dqm4hep {
  ...
  namespace dream {
    ...
    class ExampleModule : public dqm4hep::online::AnalysisModule {
    public:
      ExampleModule() = default;
      ExampleModule(const ExampleModule&) = delete;
      ExampleModule& operator=(const ExampleModule&) = delete;
    ...
    void ExampleModule::readSettings(const core::TiXmlHandle &/*handle*/) {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::initModule() {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::startOfRun(core::Run &/*run*/) {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::startOfCycle() {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::endOfCycle(const online::EOCCondition &/*condition*/) {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::endOfRun(const core::Run &/*run*/) {

    }
    
    //-------------------------------------------------------------------------------------------------
    
    void ExampleModule::endModule() {

    }
    
    //-------------------------------------------------------------------------------------------------

    void ExampleModule::process(core::EventPtr /*event*/) {

    }
    
    DQM_PLUGIN_DECL(ExampleModule, "DreamExampleModule");
